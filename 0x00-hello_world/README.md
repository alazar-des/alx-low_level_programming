Write a C program that prints the size of various types on the computer it is compiled and run on.1.  C file through the preprocessor and save the result into another file.
